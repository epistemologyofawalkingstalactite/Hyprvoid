...
-- Área seleccionada (SHIFT + print)
hl.bind("SHIFT + print", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | wl-copy"))

-- Guardar captura de pantalla con nombre así: :p (SUPER + SHIFT + print)
hl.bind(mainMod .. " + SHIFT + print", hl.dsp.exec_cmd(
    "grim -g '$(slurp)' ~/Pictures/Screenshot_$(date +%%Y%%m%%d_%%H%%M%%S).png && wl-copy < ~/Pictures/Screenshot_$(date +%%Y%%m%%d_%%H%%M%%S).png"
))
